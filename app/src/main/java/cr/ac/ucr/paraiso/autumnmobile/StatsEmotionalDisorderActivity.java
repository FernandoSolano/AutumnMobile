...
public class StatsEmotionalDisorderActivity extends AppCompatActivity {
    private List<Valuation> valuations;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_stats_emotional_disorder);
        setTitle("Trastorno emocional");
        //Objects retrieval
        Intent i = getIntent();
        ...
        if (qtyX1 != 0) {
            xVals.add("Tiene trastorno emocional");
        ...
        pieChart.setDescription("Trastorno emocional en las valoraciones de los últimos 6 meses");
